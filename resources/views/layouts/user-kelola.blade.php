                        ...
                        <div class="card-body px-0 pt-0 pb-2">
                            <div class="table-responsive p-0">
                                <table id="pelangganTable" class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        @foreach ($user as $k)
                                            @if ($k->id != Auth::id()) <!-- Cek apakah user bukan user yang sedang login -->
                                                <tr class="ps-2">
                                                    <td>
                                                    ...
                                                    <td class="align-middle">
                                                        <a href="/user-edit/{{ $k->id }}"><span
                                                                class="btn bg-gradient-warning mx-2 text-white  ">Ubah Password</span></a>
                                                        <a href="/user-delete/{{ $k->id }}"
                                ...
                                <div class="mx-3">{{ $user->withQueryString()->links() }}</div>
                            </div>
                        </div>
                    </div>
                </div>
